...
//                EndByMutualConsent
            ...
            typedef abm::MlPackAction<MessageEnum, 4 + 2 * HASLANGUAGE> Action;
...
//            DQNPolicy<Action::size> policy = DQNPolicy<Action::size>(State::dimension, 64, 32, 32, 256, 1.0);
...
//            QTablePolicy<State::nstates, Action::size> policy = QTablePolicy<State::nstates, Action::size>(1.0, 0.5, std::pow(0.02, 1.0/500000.0), 0.01);
...
//                costOfVerbosity = initialCostOfVerbosity;
        ...
        template<bool HASLANGUAGE>
        std::bitset<SugarSpiceTradingAgent<HASLANGUAGE>::Action::size> SugarSpiceTradingAgent<HASLANGUAGE>::State::legalActions() {
            std::bitset<SugarSpiceTradingAgent<HASLANGUAGE>::Action::size> legalActs;
        ...
        template<bool HASLANGUAGE>
        double SugarSpiceTradingAgent<HASLANGUAGE>::State::transition(SugarSpiceTradingAgent::Action myLastAction,
                                                                      SugarSpiceTradingAgent::Action yourResponse) {
