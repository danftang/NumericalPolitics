...
//    concept OPAAgent = requires {
//        { AGENT::NSTATES } -> std::convertible_to<std::size_t>;
//        { AGENT::NACTIONS } -> std::convertible_to<std::size_t>;
////        { agent.observe(time) } -> std::convertible_to<int>;
////        { view.act(action, time) };
//    };


//    template<class INTERFACE> requires requires {
//        { INTERFACE::NSTATES } -> std::convertible_to<std::size_t>;
//        { INTERFACE::NACTIONS } -> std::convertible_to<std::size_t>;
//    }
